...
<body>
    ...
    <section class="hero">
        <div class="hero-content fade-in">
            ...
            <p class="subtitle">Building scalable cloud infrastructure & automating deployments with modern DevOps practices</p>
    ...
    <section id="about" class="container">
        ...
        <div class="about-content">
            <div class="about-text">
                <p>I'm a DevOps Engineer focused on AWS cloud infrastructure, containerization, and automation. I enjoy working with Docker, Kubernetes, and Terraform to build efficient and reliable systems.</p>
                <p>My approach centers on infrastructure as code and CI/CD automation. I'm passionate about solving problems through scripting and configuration management, making deployments faster and more reliable.</p>
                <p>Currently expanding my skills in container orchestration, cloud architecture, and monitoring solutions while contributing to DevOps projects and learning new tools in the ecosystem.</p>
            </div>
        </div>
    </section>
        ...
        <div class="projects-grid">
            <div class="project-card">
                <div class="project-header">
                    ...
                    <p class="project-type">Containerization</p>
                </div>
                <div class="project-body">
                    <p class="project-description">
                        Built and managed a multi-container application using Docker Compose, enabling seamless communication between services and simplified local development and testing.
                    </p>
            ...
            <div class="project-card">
                <div class="project-header">
                    ...
                    <p class="project-type">Cloud & Containers</p>
                </div>
                <div class="project-body">
                    <p class="project-description">
                        Deployed a containerized Flask application on AWS ECS with task definitions, IAM roles, and load balancing for scalable and reliable application delivery.
                    </p>
                    <div class="tech-stack">
            ...
            <div class="project-card">
                <div class="project-header">
                    ...
                    <p class="project-type">Infrastructure as Code</p>
                </div>
                <div class="project-body">
                    <p class="project-description">
                        Provisioned AWS ECS infrastructure using Terraform with reusable modules, remote state management, and environment-based configurations.
                    </p>
                    <div class="tech-stack">
        ...
        <div class="contact-content">
            ...
            <div class="contact-grid">
                <div class="contact-item">
                    ...
                    <h3>Medium</h3>
                    <a href="https://medium.com/@kajals909" target="_blank">medium.com/@yourusername</a>
                </div>
                <div class="contact-item">
                    <div class="contact-icon">💼</div>
                    <h3>LinkedIn</h3>
                    <a href="www.linkedin.com/in/kajals909" target="_blank">linkedin.com/in/yourprofile</a>
                </div>
                <div class="contact-item">
                    <div class="contact-icon">💻</div>
                    <h3>GitHub</h3>
                    <a href="https://github.com/RiverByte9" target="_blank">github.com/yourusername</a>
                </div>
            </div>
        </div>
    </section>
