        ...
        <div class="contact-content">
            ...
            <div class="contact-grid">
                <div class="contact-item">
                    ...
                    <h3>Medium</h3>
                    <a href="https://medium.com/@kajals909" target="_blank">medium.com/@kajals909</a> 
                </div>
                <div class="contact-item">
                    <div class="contact-icon">💼</div>
                    <h3>LinkedIn</h3>
                    <a href="https://www.linkedin.com/in/kajals909/" target="_blank">linkedin.com/kajals909/</a> 
                </div>
                <div class="contact-item">
                    <div class="contact-icon">💻</div>
                    <h3>GitHub</h3>
                    <a href="https://github.com/RiverByte9" target="_blank">github.com/RiverByte9</a> 
                </div> 
            </div>
        </div>
    </section>
